        ...
        <div class="col-md-12 mb-4">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white">
                    <h5 class="text-center mb-0">Edit Product</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('short_des') is-invalid @enderror"
                                          ...
                                          maxlength="500" required>{{ old('short_des', $product->short_des) }}</textarea>
                                @error('short_des')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                           ...
                                           {{ old('discount', $product->discount) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('discount_price') is-invalid @enderror"
                                       ...
                                       value="{{ old('discount_price', $product->discount_price) }}" maxlength="50">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('star') is-invalid @enderror"
                                       id="star" name="star" value="{{ old('star', $product->star) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('remark') is-invalid @enderror"
                                    ...
                                    @foreach(['popular', 'new', 'top', 'special', 'trending', 'regular'] as $remark)
                                        <option value="{{ $remark }}"
                                            {{ old('remark', $product->remark) == $remark ? 'selected' : '' }}>
                                            {{ ucfirst($remark) }}
                                        </option>
                                    @endforeach
                                </select>
